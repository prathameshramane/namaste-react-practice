...
const RestaurantCard = ({ name, cloudinaryImageId, avgRating, cuisines }) => {
  ...
  return (
    <div
      data-testid="restaurant-list-card"
      className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 w-80 h-80 border border-gray-300 rounded shadow-md p-3"
    >
